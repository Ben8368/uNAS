...
- **问题：** 单一 MV3 构建、广告拦截/密码管家代码和默认 MV3 E2E 仍需在本次模块拆分后重新跑完；工具栏 `action.onClicked` 的真实系统手势、原有密码浮窗人工视觉对照、真实 WebDAV 冲突恢复、历史 UniPass 资源再分发许可和 uNAS 维护者签名 key/固定扩展 ID尚未完成。

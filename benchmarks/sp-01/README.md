...
验证 Chrome Stable 的解包更新人工对照；浏览器重启、页面关闭和 Chromium 解包更新已有自动化证据，结论再决定 RISK-003 的降级、接受或关闭。

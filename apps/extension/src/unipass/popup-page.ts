...
import unasThemeCss from './unipass/popup/unas-theme.css?inline'
...
document.head.append(Object.assign(document.createElement('style'), { textContent: [windowThemeCss, unasThemeCss, popupCss, componentsCss, themeCss, glassCss].join('\n') }))
